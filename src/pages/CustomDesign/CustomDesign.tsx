                ...
                {[...new Set(previousDesigns)]
                  ...
                  .map((design, index, array) => (
                    <button
                      ...
                      className="relative w-[70px] h-[70px] mx-auto bg-white rounded-lg border border-gray-200 hover:border-blue-500 overflow-hidden shadow-sm transition-all duration-200 hover:scale-105 focus:outline-none focus:border-blue-500 group"
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 transition-all duration-300 hover:shadow-xl">
          ...
          <div className="space-y-6 transition-all duration-300">
            ...
            <button
              ...
              className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2.5 px-4 rounded-lg shadow-md transition-all duration-200 flex items-center justify-center gap-2"
