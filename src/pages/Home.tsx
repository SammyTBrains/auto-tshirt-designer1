  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Discover unique, AI-generated t-shirt designs created with cutting-edge Stable Diffusion technology. Shop our collection of creative and original apparel."
        />
        <meta
          name="keywords"
          content="AI t-shirts, stable diffusion, custom designs, unique apparel, AI fashion"
        />
      </Helmet>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg mb-8 text-indigo-100">
                Unique t-shirts created by artificial intelligence, bringing you
                designs that have never existed before.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">
              Our community's favorite AI-generated t-shirts
            </p>
          </div>
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <div className="flex items-center text-gray-600">
                        ...
                        <span>{shirt.reviews.toLocaleString()} reviews</span>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                Every design is one-of-a-kind, generated by advanced AI
              </p>
            </div>
            <div className="text-center p-6">
              <div className="bg-indigo-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
